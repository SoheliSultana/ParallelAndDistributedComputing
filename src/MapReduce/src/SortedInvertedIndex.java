...
public class SortedInvertedIndex {
        ...
        public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
            ...
            public void map(LongWritable docId, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
                ...
                //tokennie each file splits by space
        ...
        public static class Reduce extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
            public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
                ...
                Hashtable<String, Integer> table = new Hashtable<String, Integer>();
                // iteratres values and put them into table
                ...
                List<java.util.Map.Entry<String, Integer>> list = new ArrayList<>(table.entrySet());
                // sort count by comparing value
                list.sort(java.util.Map.Entry.comparingByValue());

                StringBuilder stringBuilder = new StringBuilder();
                boolean first = true;
                for (int i=list.size()-1; i>=0; i--) {
                    java.util.Map.Entry<String, Integer> v =  list.get(i);
                    String docId = v.getKey();
                    if (first) {
        ...
        public static void main(String[] args) throws Exception {
            JobConf conf = new JobConf(SortedInvertedIndex.class);
            conf.setJobName("SortedInverted");
